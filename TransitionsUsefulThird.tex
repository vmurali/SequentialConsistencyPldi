...
We first reduce the proof of store atomicity to several lemmas.
We believe that other invalidation-based
...
MOSI, and MOESI also satisfy our lemmas, making their verification
...
The lemmas
presented below hold after any number of transitions
...
Lemmas~\ref{conservative}, \ref{localCompatibility1} and \ref{localCompatibility2}.  Proof of
